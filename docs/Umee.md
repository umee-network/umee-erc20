...
```solidity
function swapGB(uint256 amount) external nonpayable
```



*Swaps Deprecated Gravity Bridge UMEE for the new, axelar supported UMEE tokens.*
...
*Emitted when a Gravity Bridge token swap occurs.*
